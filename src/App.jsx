  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Dashboard Details (status-specific) */}
        <Route
          path="/dashboard-details/:status"
          element={isLoggedIn ? <DashboardDetails onLogout={handleLogout} /> : <Navigate to="/login" />}
        />
        ...
        <Route
          path="/list-orders"
          element={isLoggedIn ? <ListOrders onLogout={handleLogout} /> : <Navigate to="/login" />}
        />

        {/* Analytics */}
        <Route
          path="/analytics/customers"
          element={isLoggedIn ? <CustomerAnalytics onLogout={handleLogout} /> : <Navigate to="/login" />}
        />
        <Route
          path="/analytics/orders"
          element={isLoggedIn ? <OrderAnalytics onLogout={handleLogout} /> : <Navigate to="/login" />}
        />

        {/* Transactions */}
        <Route
          path="/transaction"
          element={isLoggedIn ? <Transactions onLogout={handleLogout} /> : <Navigate to="/login" />}
        />
        <Route
          path="/transaction-details"
          element={isLoggedIn ? <TransactionDetails onLogout={handleLogout} /> : <Navigate to="/login" />}
        />
